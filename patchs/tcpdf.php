	...
	public function Header() {
		if ($this->header_xobjid === false) {
			...
			if (($headerdata['logo']) AND ($headerdata['logo'] != K_BLANK_IMAGE)) {
				$imgtype = TCPDF_IMAGES::getImageFileType($this->baseImagePath.$headerdata['logo']);
				if (($imgtype == 'eps') OR ($imgtype == 'ai')) {
					$this->ImageEps($this->baseImagePath.$headerdata['logo'], '', '', $headerdata['logo_width']);
				} elseif ($imgtype == 'svg') {
					$this->ImageSVG($this->baseImagePath.$headerdata['logo'], '', '', $headerdata['logo_width']);
				} else {
					$this->Image($this->baseImagePath.$headerdata['logo'], '', '', $headerdata['logo_width']);
				}
