...
class PhpWord
{
    ...
    public function duplicateSection( \PhpOffice\PhpWord\Element\Section $section)
    {
    	//($this->sections[count($this->sections)-1])->addPageBreak();
    	$sectionCopy=$section->clone(count($this->sections) + 1);
    	$sectionCopy->setPhpWord($this);
